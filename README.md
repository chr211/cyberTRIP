...
Final Report
CyberTRIP
Team: Cooper Harris, Katelen Tellez, Chris O’Brien, Logan Kroeger
Project website: https://www.cybertrip-project.com/
Basic user account:
Username: test
Password: Password1
Account creation key: team7csc436!!!
GitHub: https://github.com/lekroee/cyberTRIP
1. Introduction
...
![Page 1 Image 1](img/page1_1.png)
...
data in JSON format. Another of the primary challenges faced by our team was ensuring the security and
...
of record storage. A consequence of the decision to use MongDB was that we needed to convert
